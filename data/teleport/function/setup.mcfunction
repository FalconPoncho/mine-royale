...
scoreboard objectives add position_y dummy position_y
scoreboard objectives remove position_z
scoreboard objectives add position_z dummy position_z
scoreboard objectives remove rotation_yaw
scoreboard objectives add rotation_yaw dummy rotation_yaw
scoreboard objectives remove rotation_pitch
scoreboard objectives add rotation_pitch dummy rotation_pitch